	...
	<view class="zai-box">
        <scroll-view scroll-y class="page">
            <view class="text-center" :style="[{animation: 'show ' + 0.4+ 's 1'}]">
				<image src="https://cdn.jsdelivr.net/gh/runrab/oss@main/app/static/lab/favicon.ico" mode='aspectFit' class="zai-logo "></image>
				<view class="zai-title text-shadow ">高校毕业生信息去向跟踪系统 </view>
			</view>
